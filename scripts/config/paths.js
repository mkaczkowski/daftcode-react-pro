...
module.exports = {
  ...
  rootenv: resolveApp(root + `.env`),
  appBuild: resolveApp(root + `build`),
  appPublic: resolveApp(root + `lpify-scripts/public`),
  htmlEmpty: resolveApp(root + `lpify-core/src/templates/index_crawler.html`),
  prodHtml: resolveApp(root + `lpify-core/src/templates/index.html`),
  devHtml: resolveApp(root + `lpify-scripts/public/index.html`),
  ...
  coreSrc: resolveApp(root + `lpify-core/src`),
  componentsSrc: resolveApp(root + `lpify-components/src`),
  yarnLockFile: resolveApp(root + `yarn.lock`),
  testsSetup: resolveApp(root + `lpify-core/src/setupTests.js`),
